...
signal FX_FIRE_BALL
signal FX_ELF_ARROW
signal FX_EXPLOSION_SMALL
signal FX_BLOCK_BREAKING
signal FX_DAMAGE_NUMBER
...
signal ROOM_LOAD_NPC_QUEST
signal ROOM_UNLOAD_NPC
signal ROOM_SHOW_PAUSE_MENU
signal ROOM_SHOW_DEATH_MENU
...
signal PLAYERS_UPDATE_EQUIPMENT
signal PLAYER_MAKE_NOICE
signal PLAYER_STEPPED_ON_SPIKES
